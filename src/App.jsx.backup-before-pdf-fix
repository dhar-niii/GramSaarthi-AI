...
const translations = {
  ...
  Gujarati: {
    ...
    actionPlanTitle: "તમારી વ્યક્તિગત કાર્ય યોજના",
    actionPlanBasedOn: "આ પર આધારિત યોજના",
    actionPlanImmediate: "તાત્કાલિક",
    actionPlanPreparation: "તૈયારી",
    actionPlanLaunch: "પ્રારંભ",
    actionPlanMonitor: "પ્રથમ નિરીક્ષણ",
    actionPlanNoData: "AI તરફથી કોઈ વિશિષ્ટ કાર્ય યોજના આપવામાં આવી નથી. શરૂ કરવા માટે નીચેની ચેકલિસ્ટનો ઉપયોગ કરો.",
    actionPlanListen: "યોજનાનું સારાંશ સાંભળો",
    governmentSupportTitle: "સરકારી અને ફાઈનાન્સિંગ માર્ગદર્શન",
    governmentSupportSubtitle: "તપાસવા માટે સંભવિત સહાય ક્ષેત્રો",
    fundingCategory: "સહાય ક્ષેત્ર",
    supportWhyRelevant: "શા માટે લાગુ પડી શકે છે",
    supportWhatToCheck: "શું તપાસવું",
    supportEligibility: "પાત્રતા નોંધ",
    supportFinancing: "વ્યવસાય નાણાકીય સહાય",
    supportTraining: "ઉદ્યોજકતા અને કુશળતા તાલીમ",
    supportAgriculture: "કૃષિ / સંબંધિત સહાય",
    supportEquipment: "સામગ્રી અને ઇન્ફ્રાસ્ટ્રક્ચર સહાય",
    supportMarketAccess: "બજાર અને ડિજિટલ સપોર્ટ",
  ...
  Hindi: {
    ...
    actionPlanBasedOn: "योजना आधारित",
    actionPlanImmediate: "तत्काल",
    actionPlanPreparation: "तैयारी",
    actionPlanLaunch: "शुरूआत",
    actionPlanMonitor: "प्रथम निगरानी",
    actionPlanNoData: "AI की ओर से कोई विशेष कार्य योजना प्रदान नहीं की गई है। शुरू करने के लिए नीचे दी गई चेकलिस्ट का उपयोग करें।",
    actionPlanListen: "योजना सार सुनें",
    governmentSupportTitle: "सरकार और वित्तीय सहायता",
    governmentSupportSubtitle: "संभावित सहायता क्षेत्र जिन्हें आप खोज सकते हैं",
    fundingCategory: "समर्थन क्षेत्र",
    supportWhyRelevant: "क्यों यह प्रासंगिक हो सकता है",
    supportWhatToCheck: "क्या जांचें",
    supportEligibility: "पात्रता नोट",
    supportFinancing: "व्यवसाय वित्तपोषण",
    supportTraining: "उद्यमिता और कौशल प्रशिक्षण",
    supportAgriculture: "कृषि / सहायक क्षेत्र सहायता",
    supportEquipment: "उपकरण और अवसंरचना सहायता",
    supportMarketAccess: "बाजार और डिजिटल सहायता",
  ...
  Marathi: {
    ...
    actionPlanTitle: "आपली वैयक्तिक कृती योजना",
    actionPlanBasedOn: "योजनेच्या आधारावर",
    actionPlanImmediate: "तुरंत",
    actionPlanPreparation: "तयारी",
    actionPlanLaunch: "प्रारंभ",
    actionPlanMonitor: "प्रथम निरीक्षण",
    actionPlanNoData: "AI कडून कोणतीही विशिष्ट कृती योजना प्रदान केलेली नाही. सुरू करण्यासाठी खालील चेकलिस्ट वापरा.",
    actionPlanListen: "योजनेचा सार ऐका",
    governmentSupportTitle: "सरकारी व वित्तीय सहाय्य मार्गदर्शन",
    governmentSupportSubtitle: "तपासासाठी संभाव्य सहाय्य क्षेत्रे",
    fundingCategory: "सहाय्य क्षेत्र",
    supportWhyRelevant: "का हे संबंधित असू शकते",
    supportWhatToCheck: "काय तपासावे",
    supportEligibility: "पात्रता नोंद",
    supportFinancing: "व्यवसाय वित्तपुरवठा",
    supportTraining: "उद्योजकता व कौशल्य प्रशिक्षण",
    supportAgriculture: "कृषी / संबंधित सहाय्य",
    supportEquipment: "उपकरण व पायाभूत सुविधा सहाय्य",
    supportMarketAccess: "बाजार व डिजिटल सहाय्य",
  ...
  Punjabi: {
    ...
    actionPlanTitle: "ਤੁਹਾਡੀ ਨਿੱਜੀ ਕਾਰਵਾਈ ਯੋਜਨਾ",
    actionPlanBasedOn: "ਯੋਜਨਾ ਆਧਾਰਤ",
    actionPlanImmediate: "ਤੁਰੰਤ",
    actionPlanPreparation: "ਤਿਆਰੀ",
    actionPlanLaunch: "ਸ਼ੁਰੂਆਤ",
    actionPlanMonitor: "ਪਹਿਲੀ ਨਿਗਰਾਨੀ",
    actionPlanNoData: "AI ਵੱਲੋਂ ਕੋਈ ਵਿਸ਼ੇਸ਼ ਕਾਰਵਾਈ ਯੋਜਨਾ ਨਹੀਂ ਦਿੱਤੀ ਗਈ। ਸ਼ੁਰੂ ਕਰਨ ਲਈ ਹੇਠਾਂ ਦਿੱਤੀ ਚੈਕਲਿਸਟ ਦੀ ਵਰਤੋਂ ਕਰੋ।",
    actionPlanListen: "ਯੋਜਨਾ ਦਾ ਸਾਰ ਸੁਣੋ",
    governmentSupportTitle: "ਸਰਕਾਰੀ ਅਤੇ ਫੰਡਿੰਗ ਮਦਦ",
    governmentSupportSubtitle: "ਖੋਜ ਕਰਨ ਲਈ ਸੰਭਾਵਿਤ ਮਦਦ ਖੇਤਰ",
    fundingCategory: "ਸਹਾਇਤਾ ਖੇਤਰ",
    supportWhyRelevant: "ਕਿਉਂ ਇਹ ਸਬੰਧਤ ਹੋ ਸਕਦਾ ਹੈ",
    supportWhatToCheck: "ਕੀ ਜਾਂਚੋ",
    supportEligibility: "ਪਾਤਰਤਾ ਨੋਟ",
    supportFinancing: "ਵਪਾਰ ਫੰਡਿੰਗ",
    supportTraining: "ਉੱਦਮੀਤਾ ਅਤੇ ਹੁਨਰ ਸਿੱਖਿਆ",
    supportAgriculture: "ਕৃষੀ / ਸਹਾਇਕ ਖੇਤਰ ਮਦਦ",
    supportEquipment: "ਸਾਜੋ-ਸਾਮਾਨ ਅਤੇ ਢਾਂਚਾ ਮਦਦ",
    supportMarketAccess: "ਬਜ਼ਾਰ ਅਤੇ ਡਿਜੀਟਲ ਮਦਦ",
  ...
  Bengali: {
    ...
    actionPlanTitle: "আপনার ব্যক্তিগত কর্মপরিকল্পনা",
    actionPlanBasedOn: "পরিকল্পনার ভিত্তিতে",
    actionPlanImmediate: "তাৎক্ষণিক",
    actionPlanPreparation: "প্রস্তুতি",
    actionPlanLaunch: "শুরু",
    actionPlanMonitor: "প্রাথমিক পর্যবেক্ষণ",
    actionPlanNoData: "AI দ্বারা কোনো নির্দিষ্ট কর্মপরিকল্পনা প্রদান করা হয়নি। শুরু করার জন্য নীচের চেকলিস্ট ব্যবহার করুন।",
    actionPlanListen: "পরিকল্পনার সারাংশ শুনুন",
    governmentSupportTitle: "সরকারি ও ফান্ডিং নির্দেশিকা",
    governmentSupportSubtitle: "অনুসন্ধানের জন্য সম্ভাব্য সহায়তা ক্ষেত্রসমূহ",
    fundingCategory: "সাহায্য ক্ষেত্র",
    supportWhyRelevant: "কেন এটি প্রাসঙ্গিক হতে পারে",
    supportWhatToCheck: "কি পরীক্ষা করবেন",
    supportEligibility: "যোগ্যতা নোট",
    supportFinancing: "ব্যবসায়িক অর্থায়ন",
    supportTraining: "উদ্যোক্তা ও দক্ষতা প্রশিক্ষণ",
    supportAgriculture: "কৃষি/সম্পর্কিত সহায়তা",
    supportEquipment: "উপকরণ ও অবকাঠামো সহায়তা",
    supportMarketAccess: "বাজার ও ডিজিটাল সহায়তা",
    supportLocalBusiness: "স্থানীয় ব্যবসা ও নিবন্ধন",
    supportVerifyOfficial: "সরকারি স্কিম এবং যোগ্যতা প্রায়ই পরিবর্তিত হয়। আবেদন করার আগে সরকারি বা আর্থিক সংস্থার অফিসিয়াল সোর্স থেকে বর্তমান বিবরণ যাচাই করুন।",
    governmentSupportNoData: "AI দ্বারা কোনো নির্দিষ্ট সরকারি সহায়তা তথ্য প্রদান করা হয়নি। নীচের ক্ষেত্রগুলি অনুসন্ধান করুন।",
  ...
  Tamil: {
    ...
    actionPlanTitle: "உங்கள் தனிப்பட்ட செயல் திட்டம்",
    actionPlanBasedOn: "திட்டத்தின் அடிப்படையில்",
    actionPlanImmediate: "உடனடி",
    actionPlanPreparation: "தயாரிப்பு",
    actionPlanLaunch: "தொடக்கம்",
    actionPlanMonitor: "முதல் கண்காணிப்பு",
    actionPlanNoData: "AI வழங்கிய எந்த குறிப்பிட்ட செயல் திட்டமும் இல்லை. தொடங்க கீழே உள்ள சேக்‌லிஸ்ட் பயன்படுத்தவும்.",
    actionPlanListen: "திட்டத்தின் சுருக்கம் கேட்கவும்",
    governmentSupportTitle: "அரசு மற்றும் நிதி ஆதரவு வழிகாட்டுதல்",
    governmentSupportSubtitle: "ஆய்வு செய்யக்கூடிய சாத்தியமான ஆதரவு பகுதிகள்",
    fundingCategory: "ஆதரவு பகுதி",
    supportWhyRelevant: "ஏன் இது தொடர்புடையதாக இருக்கலாம்",
    supportWhatToCheck: "எதை சரிபார்க்க வேண்டும்",
    supportEligibility: "தகுதி குறிப்பு",
    supportFinancing: "வணிக நிதி",
    supportTraining: "உத்யோகி மற்றும் திறன் பயிற்சி",
    supportAgriculture: "விவசாய / தொடர்புடைய ஆதரவு",
    supportEquipment: "சாதனங்கள் மற்றும் அடிப்படை உபகரண ஆதரவு",
    supportMarketAccess: "மார்க்கெட் மற்றும் டிஜிட்டல் ஆதரவு",
  ...
  Telugu: {
    ...
    actionPlanTitle: "మీ వ్యక్తిగత చర్య ప్రణాళిక",
    actionPlanBasedOn: "యోజన ఆధారంగా",
    actionPlanImmediate: "త్వరిత",
    actionPlanPreparation: "సన్నాహకాలు",
    actionPlanLaunch: "ప్రారంభం",
    actionPlanMonitor: "మొదటి పర్యవేక్షణ",
    actionPlanNoData: "AI నుండి ప్రత్యేక చర్య ప్రణాళిక అందలేదు. ప్రారంభించడానికి దిగువ చెక్‌లిస్ట్‌ను ఉపయోగించండి.",
    actionPlanListen: "ప్రణాళిక సారాంశం వినండి",
    governmentSupportTitle: "ప్రభుత్వ & ఫండింగ్ మార్గదర్శకాలు",
    governmentSupportSubtitle: "శోధించవలసిన సంభావ్య మద్దతు విభాగాలు",
    fundingCategory: "మద్దతు విభాగం",
    supportWhyRelevant: "ఎందుకు ఇది సంబంధితంగా ఉండవచ్చు",
    supportWhatToCheck: "ఏం తనిఖీ చేయాలి",
    supportEligibility: "అర్హత సూచన",
    supportFinancing: "వ్యాపార ఫైనాన్సింగ్",
    supportTraining: "ఉద్యమిత్వం & నైపుణ్య శిక్షణ",
    supportAgriculture: "వ్యవసాయ / అనుబంధ మద్దతు",
    supportEquipment: "సాధనములు & మౌలిక సదుపాయాల మద్దతు",
    supportMarketAccess: "బజార్ & డిజిటల్ మద్దతు",
  ...
  Kannada: {
    ...
    actionPlanTitle: "ನಿಮ್ಮ ವೈಯಕ್ತಿಕ ಕ್ರಿಯಾ ಯೋಜನೆ",
    actionPlanBasedOn: "ಯೋಜನೆ ಆಧಾರಿತ",
    actionPlanImmediate: "ತಕ್ಷಣ",
    actionPlanPreparation: "ಸಿದ್ಧತೆ",
    actionPlanLaunch: "ಪ್ರಾರಂಭ",
    actionPlanMonitor: "ಮೊದಲ ನಿಗಾ",
    actionPlanNoData: "AI ಇಂದ ಯಾವುದೇ ನಿರ್ದಿಷ್ಟ ಕಾರ್ಯಯೋಜನೆ ನೀಡಲಾಗಿಲ್ಲ. ಪ್ರಾರಂಭಿಸಲು ಕೆಳಗಿನ ಚೆಕ್ಲಿಸ್ಟ್ ಬಳಸಿ.",
    actionPlanListen: "ಯೋಜನೆಯ ಸಾರವನ್ನು ಕೇಳಿ",
    governmentSupportTitle: "ಸರ್ಕಾರಿ ಮತ್ತು ಹಣಕಾಸು ಮಾರ್ಗದರ್ಶನ",
    governmentSupportSubtitle: "ತपासಿಸಲು ಸಂಭಾವ್ಯ ಸಹಾಯ ಕ್ಷೇತ್ರಗಳು",
    fundingCategory: "ಸಹಾಯ ವಿಭಾಗ",
    supportWhyRelevant: "ಏಕೆ ಇದು ಸಂಬಂಧಿತವಾಗಿರಬಹುದು",
    supportWhatToCheck: "ಏನು ಪರಿಶೀಲಿಸಬೇಕು",
    supportEligibility: "ಅರ್ಹತಾ ಸೂಚನೆ",
    supportFinancing: "ವ್ಯಾಪಾರ ಹಣಕಾಸು",
    supportTraining: "ಉದ್ಯಮಶೀಲತೆ ಮತ್ತು ಕೌಶಲ್ಯ ತರಬೇತಿ",
    supportAgriculture: "ಕೃಷಿ / ಸಂಬಂಧಿತ ಸಹಾಯ",
    supportEquipment: "ಉಪಕರಣಗಳು ಮತ್ತು ಮೂಲಸೌಕರ್ಯ ಸಹಾಯ",
    supportMarketAccess: "ಮಾರುಕಟ್ಟೆ ಮತ್ತು ಡಿಜಿಟಲ್ ಸಹಾಯ",
  ...
  Malayalam: {
    ...
    actionPlanTitle: "നിങ്ങളുടെ വ്യക്തിഗത ആക്ഷൻ പദ്ധതി",
    actionPlanBasedOn: "പദ്ധതിയുടെ അടിസ്ഥാനത്തിൽ",
    actionPlanImmediate: "തൽക്ഷണം",
    actionPlanPreparation: "സജ്ജീകരണം",
    actionPlanLaunch: "തുടക്കം",
    actionPlanMonitor: "ആദ്യ നിഗര്‍വ്",
    actionPlanNoData: "AI യിൽ നിന്നുള്ള പ്രത്യേക പ്രവർത്തന പദ്ധതി ലഭിച്ചില്ല. ആരംഭിക്കാൻ താഴെയുള്ള ചെക്ക്ലിസ്റ്റ് ഉപയോഗിക്കുക.",
    actionPlanListen: "പദ്ധതിയുടെ സംഗ്രഹം കേൾക്കൂ",
    governmentSupportTitle: "സർക്കാർ & ഫണ്ടിംഗ് മാർഗ്ഗനിർദ്ദേശം",
    governmentSupportSubtitle: "പരിശോധിക്കാവുന്ന സഹായ മേഖലകൾ",
    fundingCategory: "സഹായ മേഖല",
    supportWhyRelevant: "എന്തുകൊണ്ട് ഇത് പ്രാസംഗികമായിരിക്കാം",
    supportWhatToCheck: "എന്ത് പരിശോധിക്കണം",
    supportEligibility: "യോഗ്യത കുറിപ്പ്",
    supportFinancing: "വ്യവസായ ഫിനാൻസിംഗ്",
    supportTraining: "ഉദ്യോഗശേഷി & നൈപുണ്യ പരിശീലനം",
    supportAgriculture: "കൃഷി-ബന്ധപ്പെട്ട സഹായം",
    supportEquipment: "ഉപകരണങ്ങൾ & അടിസ്ഥാന സൗകര്യ സഹായം",
    supportMarketAccess: "മാർക്കറ്റ് & ഡിജിറ്റൽ പിന്തുണ",
  ...
  Odia: {
    ...
    actionPlanTitle: "ଆପଣଙ୍କର ବ୍ୟକ୍ତିଗତ କାର୍ଯ୍ୟ ଯୋଜନା",
    actionPlanBasedOn: "ଯୋଜନା ଆଧାରିତ",
    actionPlanImmediate: "ତତ୍କାଳ",
    actionPlanPreparation: "ତିଆରି",
    actionPlanLaunch: "ଆରମ୍ଭ",
    actionPlanMonitor: "ପ୍ରଥମ ନିରୀକ୍ଷଣ",
    actionPlanNoData: "AI ଦ୍ୱାରା କୌଣସି ବିଶେଷ କାର୍ଯ୍ୟ ଯୋଜନା ଦିଆଯାଇନାହିଁ। ଆରମ୍ଭ କରିବାକୁ ନିମ୍ନର ଚେକଲିଷ୍ଟ ବ୍ୟବହାର କରନ୍ତୁ।",
    actionPlanListen: "ଯୋଜନା ସାର ଶୁଣନ୍ତୁ",
    governmentSupportTitle: "ସରକାରୀ ଏବଂ ଅର୍ଥ ସହାୟତା ମାର୍ଗଦର୍ଶନ",
    governmentSupportSubtitle: "ଖୋଜିବା ପାଇଁ ସମ୍ଭାବ୍ୟ ସହାୟତା କ୍ଷେତ୍ରଗୁଡିକ",
    fundingCategory: "ସହାୟତା କ୍ଷେତ୍ର",
    supportWhyRelevant: "ଏହା କାହିଁକି ପ୍ରସଙ୍ଗିକ ହୋଇପାରେ",
    supportWhatToCheck: "କ’ଣ ଯାଁଚ କରିବେ",
    supportEligibility: "ଯୋଗ୍ୟତା ଟୀପ୍ପଣୀ",
    supportFinancing: "ବ୍ୟବସାୟ ଅର୍ଥପୋଷଣ",
    supportTraining: "ଉଦ୍ୟମିତ୍ୱ ଏବଂ କୌଶଳ ପ୍ରଶିକ୍ଷଣ",
    supportAgriculture: "କୃଷି / ସଂଯୁକ୍ତ କ୍ଷେତ୍ର ସହାଯ୍ୟ",
    supportEquipment: "ଉପକରଣ ଏବଂ ପ୍ରାଥମିକ ସଂଖ୍ୟା",
    supportMarketAccess: "ବଜାର ଏବଂ ଡିଜିଟାଲ୍ ସହାୟତା",
